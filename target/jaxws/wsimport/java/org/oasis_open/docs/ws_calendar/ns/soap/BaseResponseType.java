...
@XmlSeeAlso({
    SubscriptionStatusResponseType.class,
    KeepAliveResponseType.class,
    StartServiceResponseType.class,
    UnsubscribeResponseType.class,
    SubscribeResponseType.class,
    GetInfoResponseType.class,
    GetPropertiesResponseType.class,
    UpdateItemResponseType.class,
    FreebusyReportResponseType.class,
    PropstatType.class,
    FetchItemResponseType.class,
    AddItemResponseType.class,
    DeleteItemResponseType.class,
    MultiOpResponseType.class,
    MultistatusType.class
})
