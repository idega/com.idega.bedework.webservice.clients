 ...
 *       
 * 
 * <p>Java class for MultistatusType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="response" type="{http://docs.oasis-open.org/ns/wscal/calws-soap}MultistatResponseElementType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "MultistatusType", propOrder = {
    "response"
})
@XmlSeeAlso({
    CalendarQueryResponseType.class
})
    ...
    extends BaseResponseType
{
     ...
     * {@link MultistatResponseElementType }
     * 
     * 
     */
    public List<MultistatResponseElementType> getResponse() {
        if (response == null) {
            response = new ArrayList<MultistatResponseElementType>();
        }
